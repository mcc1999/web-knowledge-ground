...
const registerSchema = object({
  title: string().nonempty("请输入标题").max(32, "标题长度不能超过32个字符"),
  remark: string().max(256, "标题长度不能超过256个字符").optional(),
  deadline: z
...
const EditDialog: React.FC<EditDialogProps> = (props) => {
  ...
  return (
    <Dialog open={open} onClose={onCancel}>
      <DialogTitle>
        {type === DialogType.CREATE ? "新建TODO" : "编辑TODO"}
      </DialogTitle>
      <DialogContent>
        <Box component="form">
          <TextField
